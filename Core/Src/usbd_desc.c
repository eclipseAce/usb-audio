...
#define USBD_PRODUCT_HS_STRING       "STM32 Audio"           /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING       "STM32 Audio"           /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING "STM32 Audio Config"    /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING     "STM32 Audio Interface" /* Add your Interface High Speed string */
#define USBD_CONFIGURATION_FS_STRING "STM32 Audio Config"    /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING     "STM32 Audio Interface" /* Add your Interface Full Speed string */
